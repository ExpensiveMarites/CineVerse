...
function MoviesDetail() {
    const { selectedMovieId, closeMovie, movieVideos, videosLoading, addToFavorites } = useMovies();
    ...
    useEffect(() => {
        async function getMoviesDetails() {
            try {
                ...
                console.error(err);
                setIsError("Failed to load movie details, please try again.");
            } finally {
                setIsLoading(false);
            }
        }
                    ...
                    <div className="md:flex gap-10 -mt-20 relative z-10">
                        ...
                        <div className="flex-1">
                            ...
                            <div className="mt-8 flex flex-col sm:flex-row gap-3 sm:gap-4  max-w-md mx-auto md:mx-0">
                                ...
                                {/* WATCH NOW */}
                                <button className="flex-1 bg-brand-red hover:bg-red-700 text-white font-semibold py-3 px-6 rounded-lg flex items-center justify-center gap-2 transition-all">
                                    <svg
                                ...
                                {/* WATCHLIST */}
                                <button
                                    onClick={() => addToFavorites(movie)} // adjust if needed

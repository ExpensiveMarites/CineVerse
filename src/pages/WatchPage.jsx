        ...
        <div className="min-h-screen bg-neutral-950 text-white pb-14">
            <div className="relative overflow-hidden pt-6">
                ...
                <div className="container mx-auto px-4 pt-14">
                    <button
                        onClick={handleBack}
                        className="mb-6 inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-2 text-sm text-white hover:bg-white/15"
                    >
                        ← Back
                    </button>

                    <div className={`grid gap-10 items-stretch ${isMovie ? "grid-cols-1" : "lg:grid-cols-[1.7fr_0.8fr]"}`}>
                        {/* MAIN CONTENT: player + about/details */}
                        <div className="space-y-6">
                            <div className="rounded-3xl overflow-hidden border border-white/10 bg-black/80 shadow-xl">
                                            ...
                                            <div className="rounded-2xl border border-white/10 bg-white/5 p-3">
                                                ...
                                                <div className="mt-2 flex items-center gap-2">
                                                    <button
                                                        ...
                                                        className="inline-flex h-10 w-10 items-center justify-center rounded-xl bg-white/5 text-white hover:bg-white/10"
                                                    >
                                                        −
                                                    </button>
                        ...
                        {!isMovie && (
                            <div className="flex h-full flex-col gap-6">
                                <div className="rounded-3xl border border-white/10 bg-black/80 p-6">
                                    ...
                                    <div className="mt-3 flex items-center gap-2">
                                        ...
                                        <select
                                            ...
                                            className="flex-1 rounded-xl border border-white/10 bg-black px-3 py-2 text-sm text-white"
                                        >
                                ...
                                {seasonEpisodes.length > 0 && (
                                    <div className="rounded-3xl border border-white/10 bg-black/80 p-6 h-[520px] flex flex-col">
                    ...
                    {recommendations.length > 0 && (
                        <section className="mt-10 rounded-3xl border border-white/10 bg-black/80 p-6">
                            ...
                            <div className="mt-6 flex gap-5 overflow-x-auto pb-3 snap-x snap-mandatory custom-scrollbar" >
                                {recommendations.slice(0, 6).map((item) => (
                                    <button
                                        key={item.id}
                                        onClick={() => openMedia(item.id, isMovie ? "movie" : "tv")}
                                        className="group overflow-hidden w-full rounded-3xl border border-white/10 bg-neutral-900/70 text-left transition hover:border-red-600/50"
                                    >
